...
class HostEditorAllLinuxMac extends Base
{
    ...
    {
        if (isset($this->params["host-ip"])) {
            return $this->params["host-ip"] ;
        }
    ...
    {
        if (isset($this->params["host-name"])) {
            return $this->params["host-name"] ;
        }
    ...
    protected function deleteHostFileEntryFromProjectFile()
    {
        ...
        if ($projectModel::checkIsPharaohProject()) {
            ...
            if ($allHostFileEntries instanceof \stdClass) {
                $allHostFileEntries = new \ArrayObject($allHostFileEntries);
            }
