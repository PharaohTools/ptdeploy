...
class SVNAllLinuxMac extends Base
{
    ...
    {
        if (!$autoPilot["svnCheckoutExecute"]) {
            return false;
        }
    ...
    {
        if (!$autoPilot["svnDeletorExecute"]) {
            return false;
        }
    ...
    {
        if ($this->askWhetherToDownload() != true) {
            return false;
        }
        if ($params==null) {
    ...
    {
        if (isset($this->params["repository-url"])) {
            return $this->params["repository-url"] ;
        }
    ...
    {
        if (isset($this->params["change-owner-permissions"])) {
            return true ;
        }
    ...
    {
        if ($autoPilot != null) {
            $this->webServerUser = $autoPilot["svnCheckoutWebServerUser"];
        } else {
