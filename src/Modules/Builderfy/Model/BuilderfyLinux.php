...
class BuilderfyLinux extends BaseLinuxApp
{
    ...
    public function performInstallBuildInProject()
    {
        ...
        if (!isset($this->params["no-autopilots"])) {
            if (method_exists($this, "templateAutopilots")) {
                $this->templateAutopilots() ;
            }
        }
    ...
    {
        if (isset($this->params["target-job-name"])) {
            return $this->params["target-job-name"] ;
        }
    ...
    {
        if (isset($this->params["jenkins-home"])) {
            return $this->params["jenkins-home"] ;
        }
        $question = 'What is your Jenkins home?';
        if ($this->detectJenkinsHomeFolderExistence()) {
            if (isset($this->params["guess"])) {
                return $this->jenkinsFSFolder ;
            }
    ...
    {
        if (isset($this->params["data-handling-type"])) {
            return $this->params["data-handling-type"] ;
        }
    ...
    {
        if (isset($this->params["source-build-dir"])) {
            return $this->params["source-build-dir"] ;
        }
    ...
    protected function getNewJobFolderIfJenkinsFolderExistsInFileSystem()
    {
        if ($this->detectJenkinsJobExistence()) {
            if (isset($this->params["new-job-dir"])) {
                return $this->params["new-job-dir"] ;
            }
            ...
            $this->jenkinsNewJobFolderName = $this->jenkinsOriginalJobFolderName ;
        }
    }
