...
class BuilderfyLinuxContinuousStagingToProduction extends BuilderfyLinux
{
    ...
    // Model Group
    public $modelGroup = array("ContinuousStagingToProduction") ;
    ...
    protected function getDeployDBConfInstallAutopilot()
    {
    ...
    protected function getDeployDBInstallAutopilot()
    {
    ...
    protected function templateAutopilots()
    {
        ...
        $template = $templatesDir . "/environment-invoke-continuous-staging-to-production.php" ;
