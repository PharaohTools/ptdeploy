        ...
        $this->steps =
            array(
                ...
                array ( "Builderfy" => array("continuous-staging-to-production" => array(
                    ...
                    "days-to-keep" => "-1",
                    "amount-to-keep" => "10",
                    "autopilot-test-invoke-install-file" => "",
                    "autopilot-test-invoke-dbinstall-install-file" => "build/config/ptdeploy/dapperfy/autopilots/generated/tiny-staging-invoke-code-data.php",
                    "autopilot-test-invoke-dbconf-install-file" => "build/config/ptdeploy/dapperfy/autopilots/generated/tiny-staging-invoke-code-dbconf.php",
                    "autopilot-prod-invoke-install-file" => "",
                    "autopilot-prod-invoke-dbinstall-install-file" => "build/config/ptdeploy/dapperfy/autopilots/generated/tiny-prod-invoke-code-data.php",
                    "autopilot-prod-invoke-dbconf-install-file" => "build/config/ptdeploy/dapperfy/autopilots/generated/tiny-prod-invoke-code-dbconf.php",
                    "data-handling-type" => "replication",
                    "error-email" => "",
