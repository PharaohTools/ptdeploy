        ...
        $this->steps =
            array(
                array ( "Logging" => array( "log" => array(
                    "log-message" => "Lets begin invoking Code Without Data Configuration on environment <%tpl.php%>env_name</%tpl.php%>"
                ), ) ),
                array ( "Logging" => array( "log" => array(
                ...
                array ( "SFTP" => array( "put" => array(
                    "guess" => true,
                    "source" => getcwd()."/build/config/ptdeploy/dapperfy/autopilots/generated/<%tpl.php%>env_name</%tpl.php%>-node-install-code-no-dbconf.php",
...
sudo rm <%tpl.php%>env_name</%tpl.php%>-node-install-code-no-dbconf.php
SSHDATA;
        return $sshData ;
    }
}
