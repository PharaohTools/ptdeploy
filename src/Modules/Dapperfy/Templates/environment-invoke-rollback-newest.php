    ...
    private function setSteps()
    {
        ...
        array(
            ...
            array ( "SFTP" => array( "put" => array(
                "guess" => true,
                "source" => getcwd()."/build/config/ptdeploy/dapperfy/autopilots/generated/<%tpl.php%>env_name</%tpl.php%>-node-install-rollback-newest.php",
...
sudo ptdeploy autopilot execute --autopilot-file="<%tpl.php%>env_name</%tpl.php%>-node-install-rollback-newest.php"
