...
class AptUbuntu extends BasePackager
{
    ...
    public function isInstalled($packageName)
    {
        ...
        foreach ($packageName as $package) {
            ...
            if (strpos($out, "Installed: (none)") != false) {
                $passing = false ;
            }
        }
        return $passing ;
    ...
    public function installPackage($packageName, $version = null, $versionAccuracy = null)
    {
        ...
        foreach ($packageName as $package) {
            ...
            } elseif (strpos($out, "is already the newest version.") != false) {
            ...
            } elseif (strpos($out, "ldconfig deferred processing now taking place") == false) {
    ...
    public function removePackage($packageName)
    {
        ...
        if (strpos($out, "The following packages will be REMOVED") != false) {
            ...
            return false ;
        } elseif (strpos($out, "is not installed, so not removed") != false) {
