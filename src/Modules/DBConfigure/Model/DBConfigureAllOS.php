...
class DBConfigureAllOS extends Base
{
    ...
    {
        if (isset($this->params["mysql-user"])) {
            return $this->params["mysql-user"] ;
        }
        if (isset($this->params["mysql-user-name"])) {
            return $this->params["mysql-user-name"] ;
        };
        if (isset($this->params["mysql-username"])) {
            return $this->params["mysql-username"] ;
        };
    ...
    {
        if (isset($this->params["mysql-admin-user"])) {
            return $this->params["mysql-admin-user"] ;
        }
        if (isset($this->params["admin-user"])) {
            return $this->params["admin-user"] ;
        }
    ...
    {
        if (isset($this->params["mysql-admin-pass"])) {
            return $this->params["mysql-admin-pass"] ;
        }
        if (isset($this->params["admin-pass"])) {
            return $this->params["admin-pass"] ;
        }
    ...
    {
        if (isset($this->params["mysql-password"])) {
            return $this->params["mysql-password"] ;
        }
        if (isset($this->params["mysql-pass"])) {
            return $this->params["mysql-pass"] ;
        }
    ...
    {
        if (isset($this->params["mysql-database"])) {
            return $this->params["mysql-database"] ;
        }
        if (isset($this->params["mysql-db"])) {
            return $this->params["mysql-db"] ;
        }
